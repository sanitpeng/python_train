...
from ..MarketBu.ABuDataFeed import BDApi, TXApi, NTApi, TDXApi, TDXDBApi, HBApi, SNUSApi, SNFuturesApi, SNFuturesGBApi
...
source_dict = {EMarketSourceType.E_MARKET_SOURCE_bd.value: BDApi,
               ...
               EMarketSourceType.E_MARKET_SOURCE_tdx.value: TDXApi,
               EMarketSourceType.E_MARKET_SOURCE_tdx_db.value: TDXDBApi,
